      ...
      <div className="homepage animation-appear">
        ...
        <div className="homepage-text">
          ...
          <p>
            ...
            you're a seasoned adventurer or a curious newcomer, you'll find all
            the information you need on the creatures, monsters, equipment,
            materials, and treasure that make up this vast and fascinating
            world.
          </p>
          <p>
